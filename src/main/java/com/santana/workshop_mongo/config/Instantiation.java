...
import com.santana.workshop_mongo.dto.AuthorDTO;
import com.santana.workshop_mongo.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, Instant.parse("2018-03-22T00:00:00Z"), "Bom dia", "Acordei feliz hoje!", new AuthorDTO(maria));
